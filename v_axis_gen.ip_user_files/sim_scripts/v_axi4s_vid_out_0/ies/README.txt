...
#
# Generated by export_simulation on Mon Apr 16 19:30:40 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './v_axi4s_vid_out_0.sh' script.

./v_axi4s_vid_out_0.sh -reset_run
...
./v_axi4s_vid_out_0.sh -noclean_files

For more information on the script, please type './v_axi4s_vid_out_0.sh -help'.
