...
HD_PWD='D:/FPGA/git/v_axis_gen/v_axis_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_axis_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_axis_gen.tcl
