...
HD_PWD='D:/FPGA/git/v_axis_gen/v_axis_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log v_axis_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source v_axis_gen.tcl -notrace
