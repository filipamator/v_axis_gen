...
HD_PWD='D:/FPGA/git/v_axis_gen/v_axis_gen.runs/v_axi4s_vid_out_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_axi4s_vid_out_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_axi4s_vid_out_0.tcl
